...
/// country middleware applied to the route
    ...
    /// Session Data Store and Get

    Route::get('/DataStore', [SessionDataController::class, 'DataStore'])->name('DataStore');

    Route::get('/DataGet', action: [SessionDataController::class, 'DataGet'])->name('DataGet');
   ///session data flush
    Route::get('/DataFlush', action: [SessionDataController::class, 'DataFlush'])->name('DataFlush');